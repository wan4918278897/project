...
//		String dictCode = sysDictItem.getDictId();
//		IPage<SysDictItem> pageList = sysDictItemService.getList(page,dictCode);
	...
	public Result<IPage<SysDictItem>> queryPageList2(SysDictItem sysDictItem,@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
													@RequestParam(name="pageSize", defaultValue="10") Integer pageSize,HttpServletRequest req) {
		Result<IPage<SysDictItem>> result = new Result<IPage<SysDictItem>>();
